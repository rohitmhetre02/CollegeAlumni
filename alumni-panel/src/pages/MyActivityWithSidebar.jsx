          ...
          <div className="row g-4">
            {list.map(a => (
              <div className="col-md-6" key={a._id}>
                <div className="card shadow-sm h-100" style={{ cursor: 'pointer' }} onClick={() => navigate(`/activity/${a._id}`)}>
...
export default MyActivityWithSidebar;
