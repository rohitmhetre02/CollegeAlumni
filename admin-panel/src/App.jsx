    ...
    <AuthProvider>
      <ChatProvider>
        <Router>
          ...
          <Route path="/admin/alumni/:id" element={<ProtectedRoute allowedRoles={['admin']}><AlumniDetail /></ProtectedRoute>} />
          ...
          <Route path="/admin/mentor/:mentorId" element={<ProtectedRoute allowedRoles={['admin']}><MentorProfile /></ProtectedRoute>} />
          <Route path="/admin/news" element={<ProtectedRoute allowedRoles={['admin']}><NewsList /></ProtectedRoute>} />
          <Route path="/admin/news/:id" element={<ProtectedRoute allowedRoles={['admin']}><NewsDetail /></ProtectedRoute>} />
          ...
          <Route path="/admin/gallery" element={<ProtectedRoute allowedRoles={['admin']}><Gallery /></ProtectedRoute>} />
          ...
          <Route path="/coordinator/students/:id" element={<ProtectedRoute allowedRoles={['coordinator']}><StudentDetail /></ProtectedRoute>} />
          <Route path="/coordinator/alumni" element={<ProtectedRoute allowedRoles={['coordinator']}><AlumniDirectory /></ProtectedRoute>} />
          <Route path="/coordinator/alumni/:id" element={<ProtectedRoute allowedRoles={['coordinator']}><AlumniDetail /></ProtectedRoute>} />
          ...
          <Route path="/coordinator/jobs/:id" element={<ProtectedRoute allowedRoles={['coordinator']}><JobDetail /></ProtectedRoute>} />
          <Route path="/coordinator/mentorships" element={<ProtectedRoute allowedRoles={['coordinator']}><MentorshipsList /></ProtectedRoute>} />
          <Route path="/coordinator/mentor/:mentorId" element={<ProtectedRoute allowedRoles={['coordinator']}><MentorProfile /></ProtectedRoute>} />
          <Route path="/coordinator/news" element={<ProtectedRoute allowedRoles={['coordinator']}><NewsList /></ProtectedRoute>} />
          <Route path="/coordinator/news/:id" element={<ProtectedRoute allowedRoles={['coordinator']}><NewsDetail /></ProtectedRoute>} />
          ...
          <Route path="/coordinator/gallery" element={<ProtectedRoute allowedRoles={['coordinator']}><Gallery /></ProtectedRoute>} />
          <Route path="/coordinator/messages" element={<ProtectedRoute allowedRoles={['coordinator']}><Messages /></ProtectedRoute>} />
          <Route path="/profile" element={<ProtectedRoute allowedRoles={['admin','coordinator']}><Profile /></ProtectedRoute>} />
